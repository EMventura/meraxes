  ...
  if (gal->EjectedGas > 0 && ReincorporationEff > 0.) {
    ...
    switch (ReincorporationModel) {
      case 1:
        ...
        break;
      case 2:
        /*#if USE_MINI_HALOS Remove this to test!
                mlog_error("ReincorporationModel = 2 when using Minihalos leads to no reincorporation, change it to
        1!"); ABORT(EXIT_FAILURE); break; #endif*/
